...
- The final rules/announcement recheck and official form submission remain explicit Phase 5C user actions. The externally verified demo video URL is tracked in the submission documents; the repository does not claim that the Devfolio submission already exists.
